...
#luxnest-ai-toggle{display:flex;align-items:center;gap:8px;padding:0 20px 0 14px;height:56px;background:linear-gradient(135deg,#FF5B00,#FF8E53);color:#fff;border-radius:28px;cursor:pointer;box-shadow:0 8px 25px rgba(255,91,0,.4);transition:all .4s cubic-bezier(.175,.885,.32,1.275);border:2px solid rgba(255,255,255,.2);font-size:26px}
#luxnest-ai-toggle.hidden{display:none}
.ai-toggle-label{font-size:.92rem;font-weight:600;white-space:nowrap}
#luxnest-ai-toggle:hover{transform:scale(1.08) rotate(4deg);box-shadow:0 12px 30px rgba(255,91,0,.5)}
#luxnest-ai-tooltip{position:absolute;bottom:75px;right:0;width:240px;z-index:1000;filter:drop-shadow(0 10px 25px rgba(255,91,0,.25));transition:all .5s cubic-bezier(.175,.885,.32,1.275);cursor:pointer}
#luxnest-ai-tooltip.hidden{opacity:0;transform:translateY(15px) scale(.9);pointer-events:none}
.ai-tooltip-content{background:linear-gradient(135deg,#FF5B00,#FF8E53);color:#fff;padding:14px 18px;border-radius:18px;font-size:.88rem;font-weight:500;line-height:1.5;text-align:center;animation:tooltip-pulse 3s infinite ease-in-out}
.ai-tooltip-arrow{position:absolute;bottom:-8px;right:32px;width:16px;height:16px;background:#FF8E53;transform:rotate(45deg);z-index:-1}
...
.ai-header{background:linear-gradient(135deg,#FF5B00,#E04F00);color:#fff;padding:16px 20px;display:flex;justify-content:space-between;align-items:center}
...
.system-message .ai-bubble strong{color:#FF5B00}
.ai-avatar{width:32px;height:32px;background:#FF5B00;color:#fff;border-radius:10px;display:flex;align-items:center;justify-content:center;font-size:18px;flex-shrink:0;box-shadow:0 4px 10px rgba(255,91,0,.2)}
.ai-avatar-agent{background:linear-gradient(135deg,#FF5B00,#FF8E53);font-size:.95rem;font-weight:700;border-radius:50%}
...
.user-message .ai-bubble{background:#FF5B00;color:#fff;border-radius:16px 16px 4px 16px;border:none;box-shadow:0 4px 12px rgba(255,91,0,.2)}
.ai-typing{display:flex;gap:5px;padding:8px}
.ai-typing span{width:6px;height:6px;background:#FF5B00;border-radius:50%;animation:typing 1.4s infinite ease-in-out both;display:inline-block}
...
.ai-room-price{font-size:.86rem;font-weight:700;color:#FF5B00;margin-top:2px}
.ai-room-price span{font-size:.7rem;font-weight:400;color:#999}
.ai-room-book{display:inline-flex;align-items:center;gap:4px;margin-top:5px;padding:5px 10px;background:#FF5B00;color:#fff !important;border-radius:8px;font-size:.76rem;font-weight:600;text-decoration:none !important;transition:background .2s;align-self:flex-start}
.ai-room-book:hover{background:#E04F00}
...
#luxnest-ai-input:focus{background:#fff;border-color:#FF5B00;box-shadow:0 0 0 3px rgba(255,91,0,.1)}
#luxnest-ai-send{width:44px;height:44px;border:none;background:#FF5B00;color:#fff;border-radius:12px;display:flex;align-items:center;justify-content:center;cursor:pointer;font-size:1.2rem;transition:all .3s;flex-shrink:0}
#luxnest-ai-send:hover{background:#E04F00;transform:translateY(-1px)}
