        ...
        <div class="villa-grid">
            ...
            <div class="villa-item-horizontal">
                <div class="villa-item-gallery">
                    <a href="{{ route('villa.show', $villa->slug) }}" class="main-image-link">
                ...
                <div class="villa-item-content">
                    <h3 class="villa-name">
                        <a href="{{ route('villa.show', $villa->slug) }}" style="color:inherit;text-decoration:none;">{{ $villa->name }}</a>
                    </h3>
                ...
                <div class="villa-item-action">
                    <a href="{{ route('villa.show', $villa->slug) }}" class="villa-call-btn">
